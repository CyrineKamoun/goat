...
TOOL_REGISTRY: tuple[ToolDefinition, ...] = (
    ...
    ToolDefinition(
        ...
        description="Filters features that do not intersect any feature in the overlay layer",
        module_path="goatlib.tools.disjoint",
        params_class_name="DisjointToolParams",
        docs_path="/toolbox/geoprocessing/disjoint",
        windmill_path="f/goat/tools/disjoint",
        category="geoprocessing",
        keywords=(
            "geoprocessing",
            "disjoint",
