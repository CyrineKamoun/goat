...
def run_pipeline(
    *,
    ...
    catalog_owner_user_id: str | None = None,
    catalog_folder_name: str = "catalog",
    timeout_seconds: int,
    poll_seconds: int,
) -> dict[str, Any]:
    ...
    sync_summary = run_sync(
        ...
        catalog_owner_user_id=(uuid.UUID(catalog_owner_user_id) if catalog_owner_user_id else None),
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--customer-schema", default="customer", help="PostgreSQL schema for customer layers")
    parser.add_argument("--catalog-owner-user-id", default=None, help="UUID of the owner user for catalog layers in customer.layer")
    parser.add_argument("--catalog-folder-name", default="catalog", help="Name of the folder to place catalog layers in")
...
def main() -> None:
    ...
    pipeline_kwargs = {
        ...
        "customer_schema": args.customer_schema,
        "catalog_owner_user_id": args.catalog_owner_user_id,
        "catalog_folder_name": args.catalog_folder_name,
